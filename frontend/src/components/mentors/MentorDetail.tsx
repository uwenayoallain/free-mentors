        ...
        <Box>
                    ...
                    <Box sx={ { position: 'sticky', top: 24 } }>
                        <Paper sx={ { p: 3, mb: 3 } }>
                            <Box sx={ { display: 'flex', flexDirection: 'column', alignItems: 'center', mb: 3 } }>
                                <Avatar
                                    src={ mentor.profilePicture || `https://i.pravatar.cc/300?u=${mentor.id}` }
                            ...
                            <Box sx={ { mb: 2 } }>
                                ...
                                <Typography variant="body2">
                                    { mentor.yearsOfExperience } { mentor.yearsOfExperience === 1 ? 'year' : 'years' } of experience
                                </Typography>
                            </Box>
            ...
            >
                ...
                <DialogContent dividers>
                    <RequestSessionForm mentorId={ mentor.id } onSuccess={ handleCloseDialog } />
                </DialogContent>
                <DialogActions>
