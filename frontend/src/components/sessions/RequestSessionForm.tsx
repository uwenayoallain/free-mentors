...
const RequestSessionForm: React.FC<RequestSessionFormProps> = ({ mentorId, onSuccess }) => {
    ...
    return (
        <Box component="form" onSubmit={ handleSubmit(onSubmit) } noValidate>
                            ...
                            <DatePicker
                                ...
                                slotProps={ {
                                    textField: {
                                        fullWidth: true,
                                        margin: 'normal',
                                        helperText: 'You can select a preferred date or leave it blank',
                                    },
                                } }
                            />
                        ) }
            ...
            <FormHelperText>
                Your session request will be sent to the mentor, who can accept or decline.
            </FormHelperText>
