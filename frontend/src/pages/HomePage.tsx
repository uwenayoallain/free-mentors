        ...
        <Stack direction={ { xs: "column", md: "row" } } spacing={ 3 }>
          <Box sx={ { flex: 1, width: "100%" } }>
            ...
            >
              ...
              <Typography variant="body2" color="text.secondary" align="center">
                Browse through our diverse pool of experienced mentors from
                various fields.
              </Typography>
            </Paper>
          </Box>
          <Box sx={ { flex: 1, width: "100%" } }>
            ...
            >
              ...
              <Typography variant="body2" color="text.secondary" align="center">
                Send a mentorship request with details about what you'd like to
                discuss.
              </Typography>
            </Paper>
          </Box>
          <Box sx={ { flex: 1, width: "100%" } }>
            ...
            >
              ...
              <Typography variant="body2" color="text.secondary" align="center">
                Gain insights, knowledge, and guidance to help you succeed in
                your journey.
              </Typography>
            </Paper>
          </Box>
